...
<div className={styleG.parent}>
  <div className={styleG.body_container}>
    ...
    <section>
      <div class="text">
        <h2>¿Cómo funciona?</h2>
        <p><b>Experiencia y conocimiento:</b> Contamos con un equipo de expertos en atención al cliente que entienden las necesidades específicas de las empresas de delivery.</p>
        <p>Solución personalizada:<b></b> Nexo se adapta a tus procesos y flujos de trabajo, brindándote una solución a medida para tu negocio.</p>
        <p><b>Soporte y acompañamiento:</b>Te brindamos soporte técnico y capacitación para que puedas aprovechar al máximo todas las funcionalidades de Nexo.</p>
        <p><b>Precios competitivos:</b>Ofrecemos planes flexibles que se adaptan a tu presupuesto y a tus necesidades.</p>
      </div>
    </section>
    <section>
      <h2>
