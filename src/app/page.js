...
<div
  ...
  <main className={stylesG.mainHome}>
    <section className={stylesG.section}>
      <div className={stylesG.text__container}>
        <h2>¿Cómo funciona?</h2>
        <p>
          <b>Registro de casos:</b> El cliente se comunica con tu empresa a través de tu canal de atención preferido
          (teléfono,
          correo electrónico, chat, etc.). Tu equipo de atención al cliente registra los detalles del caso en Nexo,
          incluyendo la información del cliente, la descripción del problema y cualquier otra información
          relevante.
        </p>
        <p>
          <b>Seguimiento y gestión:</b> Una vez registrado el caso, se asigna un responsable y se establece una
          prioridad. El
          equipo de atención al cliente puede actualizar el estado del caso, agregar comentarios y adjuntar archivos
          según
          sea necesario.
        </p>
        <p>
